...
#### 4. 显示算力值 - [dashboard_screen.dart](../mobile_client/bitcoin_mining_master/lib/screens/dashboard_screen.dart)
...
1. **启动应用**：
   ```bash
   cd c:\Dev\Bitcoin_Mining_Master\mobile_client\bitcoin_mining_master
...
4. **mobile_client/bitcoin_mining_master/lib/screens/dashboard_screen.dart**
