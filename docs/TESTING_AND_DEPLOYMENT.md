...
2. **找到 APK 文件**
   ```
   mobile_client/Bitcoin_Mining_Master/app/build/outputs/apk/debug/app-debug.apk
   ```
...
1. **创建签名密钥**
   ...
   在终端执行:
   ```bash
   cd mobile_client/Bitcoin_Mining_Master/app
...
6. **找到 Release APK**
   ```
   mobile_client/Bitcoin_Mining_Master/app/build/outputs/apk/release/app-release.apk
   ```
