...
const playNotificationsRoutes = require('./routes/playNotifications'); // Google Play RTDN webhook
...
app.use('/api/play-notifications', playNotificationsRoutes); // Google Play RTDN webhook
